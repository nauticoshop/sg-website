        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <aside className="lg:col-span-4 order-2 lg:order-1">
            <div className="lg:sticky lg:top-32 space-y-10">
              <div>
                <h2 className="caption text-gold mb-4">GET IN TOUCH</h2>
                <ul className="space-y-3">
                  <li>
                    <a
                      href={`mailto:${site.contact.email}`}
                      className="text-lg text-ink hover:text-gold transition-colors"
                    >
                      {site.contact.email}
                    </a>
                  </li>
              ...
              <div>
                <h2 className="caption text-gold mb-4">STUDIO</h2>
              ...
              <div>
                <h2 className="caption text-gold mb-4">FOLLOW</h2>
                <ul className="space-y-3">
                  <li>
                    <a
